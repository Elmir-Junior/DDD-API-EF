...
namespace WebApp.ApplicationPresentation
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ServiceApiTecnologia>();
            services.AddScoped<ServiceApiVaga>();
            services.AddScoped<ServiceApiCandidato>();
        }
